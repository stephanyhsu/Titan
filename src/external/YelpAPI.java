...
public class YelpAPI implements ExternalAPI {
	...
	//private static final String CLIENT_ID = "PIFvv7ksB83qxdS6m8MD-g";
	private static final String CLIENT_SECRET = "LZbTtqX3rvYASPtOhgSlvcGIv6yMBjjMmdP-aszFXBBoKT_HphQksK279l32iCH9lAGoGgZcNM_irRkuktjVQl19p-vo1d6v9el5PyBJx30pLelS0A-sW_IVjdRnW3Yx";
...
//	}
	...
	public List<Item> search(double lat, double lon, String term) {
		...
		try {
			...
			// add request header
			connection.setRequestProperty("Authorization", TOKEN_TYPE + " " + CLIENT_SECRET); // No need to get Token
